                    ...
                    <div className="w-full max-w-md">
                        <div className="bg-base-100/80 rounded-2xl shadow-2xl px-6 sm:px-8 sm:py-10 border border-base-200">
                            <div role="tablist" className="tabs tabs-bordered mb-8 flex justify-center tabs-lg">
                                <Link to="/signup" className="tab  text-lg font-semibold tracking-wide">
                                    Sign Up
                                </Link>
                                <Link to="/login" className="tab tab-active text-lg font-semibold tracking-wide">
                                    Log In
                                </Link>
                            </div>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button type="submit" className="btn btn-primary w-full text-lg font-bold tracking-wide shadow-md" disabled={isLoggingIn}>
                                    {isLoggingIn ? (
                                        <>
