        ...
        <aside className="flex flex-col h-full w-60 bg-base-100 border-r border-base-300">
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-6">
                ...
                <div className="space-y-1">
                    <Link
                        to="/new"
                        className="bg-secondary flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-primary/80 transition-colors text-base-content/80 hover:text-base-content"
                    >
                        <Plus className="w-5 h-5 text-base-100" />
                        <span className="font-medium text-base-100">Create Echo</span>
                    </Link>
                    <Link
                        to="/"
            ...
            <div className="p-4 border-t border-base-300 space-y-1">
                <Link
                    to="/profile"
                    className="bg-base-200/50 flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-base-200 transition-colors text-base-content/80 hover:text-base-content"
                >
